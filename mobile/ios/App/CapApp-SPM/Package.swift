...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLocalNotifications", path: "../../../node_modules/.pnpm/@capacitor+local-notifications@8.2.0_@capacitor+core@8.3.0/node_modules/@capacitor/local-notifications"),
